...
static int demande_nb_joueur(void)
{
    ...
    while (1)
    {
        ...
        else if (njoueur != 1 && njoueur != 2 && njoueur !=3 && njoueur !=4)
...
static int ia(void)
{
     ...
     * colonne ayant la plus haute valeur.
     *Plusieurs valeurs égales => un numéro de colonne est « choisi au hasard » parmi celles-ci.
     */
...
static int iaMed(void)
{
    /*
     *Même fonction que iA mais longueur a pour longueur 4
     */
...
static int iaHard(void)
{
    /*
     *Même fonction que ia sauf que la longueur vaut maintenant 6.
     */
...
int main(void)
{
    ...
    while (1)
    {
        ...
        else if (njoueur == 2 && jeton == J2_JETON)
        {
            coup = iaMed();
            printf("Joueur 2 : %d\n", coup + 1);
            calcule_position(coup, &pos);
        ...
        else if (njoueur == 3 && jeton == J2_JETON)
        {
            coup = iaHard();
            printf("Joueur 2 : %d\n", coup + 1);
            calcule_position(coup, &pos);
        ...
        {
            printf("Joueur %d : ", (jeton == J1_JETON) ? 1 : 4);
